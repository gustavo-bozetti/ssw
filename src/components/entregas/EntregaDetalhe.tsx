...
export default function EntregaDetalhe({ id }: { id: string }) {
  ...
  if (!entrega) {
    return (
      <div className="min-h-screen bg-[#F3F3F3] flex flex-col items-center justify-center gap-3">
        ...
        <button onClick={() => router.push("/entregas")} className="text-[#2EA3F2] text-sm font-medium">
          Voltar à lista
        </button>
      </div>
    )
        ...
        <div className="lg:hidden max-w-lg mx-auto px-4 py-4">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2 flex-1">
              ...
              <span className="text-base font-bold text-[#1F1F1F]">Entrega</span>
            </div>
            ...
            {etiquetas && etiquetas.length > 0 && (
              <div className="mt-3 pt-3 border-t border-gray-100">
                ...
                <button
                  ...
                  className="w-full bg-[#2EA3F2] text-white rounded-xl py-2.5 text-sm font-semibold disabled:opacity-50"
                >
